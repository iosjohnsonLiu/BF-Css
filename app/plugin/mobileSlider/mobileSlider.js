...
(function($){
  $.fn.mobileSlider = function(settings){
    ...
    return this.each(function(){
      ...
      oFocusContainer.css({
        minHeight: $(this).find('span').height() * 1.5,
        maxHeight: $(this).find('span').height() * 2,
        position: 'absolute',
        bottom: 0,
